...
lvim.default_options = {}
--- No surround sound ---
lvim.default_options.errorbells = false
lvim.default_options.visualbell = false

-- For index
lvim.default_options.wrap = true
lvim.default_options.autoindent = true
lvim.default_options.copyindent = true
lvim.default_options.smartindent = true
lvim.default_options.cindent = true
lvim.default_options.cinoptions = ":0g0"
lvim.default_options.smarttab = true
lvim.default_options.shiftround = true

--- Format ---
lvim.default_options.tabstop = 4
lvim.default_options.shiftwidth = 4
lvim.default_options.softtabstop = 4
lvim.default_options.expandtab = true

--- Encoding setting ---
lvim.default_options.fileencodings = "ucs-bom,utf-8,cp936,gb18030,big5,euc-jp,euc-kr,latin1"

--- Search and Case ---
lvim.default_options.gdefault = true
lvim.default_options.ignorecase = true
lvim.default_options.smartcase = true
lvim.default_options.hlsearch = true
lvim.default_options.incsearch = true
lvim.default_options.fileignorecase = true
lvim.default_options.showcmd = true

--- Rule the define ---
lvim.default_options.ruler = true
lvim.default_options.cursorline = true
lvim.default_options.number = true

--- always show signcolumns ---
lvim.default_options.signcolumn = "yes"

--- faster completion ---
lvim.default_options.updatetime = 300

--- No back up files ---
lvim.default_options.swapfile = false
lvim.default_options.backup = false
lvim.default_options.writebackup = false

--- Mouse ---
lvim.default_options.mouse = "a"
lvim.default_options.mousemodel = "popup_setpos"

--- Undo ---
lvim.default_options.undolevels = 1000

--- Fold ---
lvim.default_options.foldmethod = "indent"
lvim.default_options.foldlevel = 100

--- split ---
lvim.default_options.splitbelow = true -- force all horizontal splits to go below current window
lvim.default_options.splitright = true -- force all vertical splits to go to the right of current window

--- Other ---
lvim.default_options.helplang = "cn"
lvim.default_options.backspace = 'indent,eol,start'
lvim.default_options.cscopetag = true
lvim.default_options.cscopetagorder = 1
lvim.default_options.virtualedit = 'block'
lvim.default_options.wildmenu = true
lvim.default_options.showmatch = true
lvim.default_options.matchtime = 2
lvim.default_options.title = true
lvim.default_options.autoread = true
lvim.default_options.clipboard = "unnamedplus,unnamed"
lvim.default_options.history = 1000
lvim.default_options.maxmempattern = 2000000
lvim.default_options.pumheight = 50
lvim.default_options.timeoutlen = 100

for k, v in pairs(lvim.default_options) do
    vim.opt[k] = v
end
